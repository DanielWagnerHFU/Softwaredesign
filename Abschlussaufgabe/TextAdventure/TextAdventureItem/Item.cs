...
namespace TextAdventureItem
{
    public abstract class Item
    {
        ...
        public void AddSpawnItem(Item item) => _spawnOnUseItems.Add(item);

        public string GetDescription() => _description;

        protected bool CharacterIsPlayer(Character character) => character.GetType() == typeof(PlayerCharacter);
